...
/*!
  ...
  \details This is a modification of \ref "max(a, b)". Here, (a) and (b) are evaluated only once. Their values are
  assigned to the local variables \a _a and \a _b. Note that since this is actually statement expression,
  therefore, the last statement must always be an expression.

  But this function has a problem and that is <em>variable shadowing</em>.
  \example example.c
 */
...
/*!
  ...
  \details However this has one problem and that is, \a (a) or \a (b) is evaluated twice. Once
